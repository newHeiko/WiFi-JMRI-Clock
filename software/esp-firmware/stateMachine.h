...
enum state { STATE_STARTUP, STATE_CONNECTING, STATE_CONNECTED, STATE_SERVERCONN, STATE_ONLINE, STATE_CONFIG_AP, STATE_CONFIG_STATION_WAITING, STATE_CONFIG_STATION};
